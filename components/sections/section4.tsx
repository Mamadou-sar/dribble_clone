   ...
   return (
      <div className='flex flex-col items-center justify-center p-4 bg-primary/50 text-center'>
         ...
         <p className='text-lg mb-6'>
            The world&apos;s leading brands use Dribbble to hire creative talent. Browse millions of
            top-rated portfolios to find your perfect creative match.
         </p>
         ...
         <p>
            Are you a designer? <Link href='#'>Join Dribbble</Link>
         </p>
      </div>
   );
};
