...
const designers: Designer[] = [
   {
      ...
      image: '/img.jpg?height=200&width=200',
      skills: ['Illustration', 'Mobile', 'UI'],
   },
   {
      id: 2,
         ...
         >
            <div className='flex justify-between'>
               {[...designers, ...designers].map((designer, index) => (
                  <div
                     key={index}
                     className='flex-none w-72 h-80 m-4 relative overflow-hidden rounded-lg shadow-lg'
                  >
                     <Image
                        src={designer.image}
                        alt='designer'
